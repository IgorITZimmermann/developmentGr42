...
public class TestHeadset {
    public static void main(String[] args) {
        ...
        SamsungHeadsetExperimental samsungHeadsetExperimental = new SamsungHeadsetExperimental(true,"white",ConnectionType.WIRELESS,"Samsung",Size.SMALL,70, true,ChargingType.INDUCTION,true,2000);
